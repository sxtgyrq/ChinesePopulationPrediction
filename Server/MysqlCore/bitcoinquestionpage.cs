...
namespace MysqlCore
{
    ...
    //                int count;
    //                {
    //                    string sQL = $"SELECT COUNT(*) FROM bitcoinquestionpage WHERE BitcoinAddress='{address}';";
    ...
    //                if (count == 0)
    //                {
    //                    string sQL = $"INSERT INTO bitcoinquestionpage (BitcoinAddress,SuccessCount) VALUES ('{address}',1);";
    //                    using (var command = new MySqlCommand(sQL, con, tran))
    //                    {
    ...
    //                else
    //                {
    //                    string sQL = $"UPDATE bitcoinquestionpage SET SuccessCount = SuccessCount + 1 WHERE BitcoinAddress = '{address}';";
    //                    using (var command = new MySqlCommand(sQL, con, tran))
    //                    {
    //                        command.ExecuteNonQuery();
    //                    }
    //                }
    //                moneycountAddV = moneycount.Add("bitcoinquestionpage", address, con, tran);
    //                {
    //                    tran.Commit();
    //                }
    //            }
    ...
    //    static string sheetName = "bitcoinquestionpage";
    //    static string xunzhangName = "椭圆加密";
