...
namespace MysqlCore
{
    ...
    //                int count;
    //                {
    //                    string sQL = $"SELECT COUNT(*) FROM kekonghejubian WHERE BitcoinAddress='{address}';";
    ...
    //                if (count == 0)
    //                {
    //                    string sQL = $"INSERT INTO kekonghejubian (BitcoinAddress,SuccessCount) VALUES ('{address}',1);";
    //                    using (var command = new MySqlCommand(sQL, con, tran))
    //                    {
    ...
    //                else
    //                {
    //                    string sQL = $"UPDATE kekonghejubian SET SuccessCount = SuccessCount + 1 WHERE BitcoinAddress = '{address}';";
    //                    using (var command = new MySqlCommand(sQL, con, tran))
    //                    {
    //                        command.ExecuteNonQuery();
    //                    }
    //                }
    //                moneycountAddV = moneycount.Add("kekonghejubian", address, con, tran);
    //                {
    //                    tran.Commit();
    //                }
    //            }
    ...
    //    const string sheetName = "kekonghejubian";
    //    const string xunzhangName = "人造小太阳";
