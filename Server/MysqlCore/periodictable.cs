...
namespace MysqlCore
{
    ...
    //    const string sheetName = "periodictable";
    //    const string xunzhangName = "元素周期表";
    ...
    //    }
    //}
    //int countofxunzhang, string xunzhangType, decimal price, string addressFrom
    public delegate string sellObj(int countofxunzhang, string xunzhangType, decimal price, string addressFrom, string[] signs);


    public delegate string BuyObj(string addrv, long xunzhangCount, decimal price, string[] signs);
}
