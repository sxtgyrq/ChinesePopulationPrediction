...
namespace EccCore
{
    public class Sign
    {
        ...
        public static string verify_message(string signature, string message, string address)
        {
            byte[] sig;
            //try
            {
            ...
            else
            {
                ...
                var addressResult = compressed ? PublicKeyF.GetAddressOfcompressed(Q) : PublicKeyF.GetAddressOfUncompressed(Q);
                addressResult = addressResult.Trim();
                if (address.Trim() == addressResult)
                {
                    return "OK";
                }
                else
        ...
        private static byte[] msg_digest(string message)
        {
